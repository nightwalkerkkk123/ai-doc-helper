...
export default function App() {
  ...
  return (
    <div className="relative flex h-screen flex-col overflow-hidden bg-slate-50 font-sans text-slate-900 selection:bg-blue-100">
      {toast.show && (
        <Toast
      ...
      <UploadModal
        ...
        onUploadComplete={() => showToast('上传成功，后台处理中', 'success')}
      />
    </div>
  )
}
